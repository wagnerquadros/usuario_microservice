package com.wagnerquadros.usuario.infrastructure.security;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.wagnerquadros.usuario.infrastructure.exceptions.dto.ErrorResponseDTO;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private String buildError(int status, String mensagem, String error, String path){
